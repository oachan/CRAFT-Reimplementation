...
parser.add_argument('--base_data_dir', default=None, type=str,
                    help='the base data Synth80k directory path')
parser.add_argument('--input_data_dir', default=None, type=str,
                    help='the input train data directory path')
parser.add_argument('--output_model_dir', default=None, type=str,
                    help='the output model directory path')
...
if __name__ == '__main__':
    ...
    net = CRAFT()
    net.load_state_dict(copyStateDict(torch.load(args.pretrain_model)))
    net = net.cuda()
    ...
    dataloader = Synth80k(args.base_data_dir, target_size=768)
    ...
    realdata = PRL5fold(net, args.input_data_dir, target_size=768, viz=False)
