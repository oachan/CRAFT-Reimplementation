...
parser.add_argument('--trained_model', default='./epoch_weights/SciTSR/SciTSR_epoch_1_batch_950.pth', type=str, help='pretrained model')
...
image_list, _, _ = file_utils.get_files('./data/SciTSR/test/img/')

result_folder = './results/SciTSR/'
